...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      fetchData() {
        axios.get('https://php.impetusapp.com/ajaxProfile.php', {
      ...
      decline(param) {
        ...
        axios.get('https://php.impetusapp.com/declineEvent.php?event_id=' + param, {
          withCredentials: true
        }).then((resp) => {
          console.log(resp)
      ...
      handleReq(id, user, team, player_rank, player_score) {
        axios.post('https://php.impetusapp.com/handleRequest.php', {
          user_id: id,
          username: user,
          teamname: team,
          rank: player_rank,
      ...
      accept() {
        axios.post('https://php.impetusapp.com/editProfile.php', {
