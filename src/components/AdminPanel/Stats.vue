...
<script>
  ...
  export default {
    ...
    methods: {
      delUser() {
        axios.get('https://php.impetusapp.com/delUser.php?id=' + this.delUser_id, {
      ...
      delEvent() {
        axios.get('https://php.impetusapp.com/delEvent.php?id=' + this.delEvent_id, {
          withCredentials: true
        }).then((response) => {
          this.modalShow = !this.modalShow
        })
      ...
      newAnnouncement() {
        ...
        axios.post('https://php.impetusapp.com/newAnnouncement.php', {
