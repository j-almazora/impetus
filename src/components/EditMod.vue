...
export default {
  ...
  mounted() {
      axios.get('https://php.impetusapp.com/getMods.php', {
    ...
    methods: {
        addMod(){
            axios.get('https://php.impetusapp.com/addMod.php?id='+this.add_id, {
             withCredentials: true
            }).then((response) => {
        ...
        delMod(){
            axios.get('https://php.impetusapp.com/delMod.php?id='+this.del_id, {
             withCredentials: true
            }).then((response) => {
